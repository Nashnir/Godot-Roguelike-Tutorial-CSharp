...
namespace SuperRogalik
{
    public partial class Tile : Sprite2D
    {
        ...
        public const string DOWN_STAIRS = "down_stairs";
        public static readonly Dictionary<string, TileDefinition> tileTypes = new() {
            ...
            { DOWN_STAIRS, ResourceLoader.Load<TileDefinition>("res://assets/definitions/tiles/tile_definition_down_stairs.tres") },
        };
