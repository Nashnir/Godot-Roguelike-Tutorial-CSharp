...
namespace SuperRogalik
{
    public partial class DungeonGenerator : Node
    {
        ...
        static readonly Dictionary<int, Dictionary<string, int>> item_chances = new(){
            { 0, new Dictionary<string, int>{ {Entity.HEALTH_POTION, 35}, }},
            { 2, new Dictionary<string, int>{ {Entity.CONFUSION_SCROLL, 10}, }},
            { 4, new Dictionary<string, int>{ {Entity.LIGHTING_SCROLL, 25}, {Entity.SWORD, 5}, }},
            { 6, new Dictionary<string, int>{ {Entity.FIREBALL_SCROLL, 25}, {Entity.CHAINMAIL, 15}, }},
        };

        static readonly Dictionary<int, Dictionary<string, int>> enemy_chances = new(){
            { 0, new Dictionary<string, int>{{Entity.ORC, 80}, }},
            { 3, new Dictionary<string, int>{{Entity.TROLL, 15}, }},
            { 5, new Dictionary<string, int>{{Entity.TROLL, 30}, }},
            { 7, new Dictionary<string, int>{{Entity.TROLL, 60}, }},
        };
